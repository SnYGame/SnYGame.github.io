...
- The 1.3.0 changes to Life Link were reverted and the status was renamed to Destiny Bond. Its original name was slightly changed and given to a new weird status called Lifelink with the following description: Any changes in target’s health are also applied to [partner].
