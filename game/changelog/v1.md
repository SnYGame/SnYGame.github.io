...
- Multi-Mitigator was removed, reverting the [1.4.10](v1#v1.4.10) changes to Mitigator.
...
- The [1.3.0](v1#v1.3.0) changes to Life Link were reverted and the status was renamed to Destiny Bond. Its original name was slightly changed and given to a new weird status called Lifelink with the following description: Any changes in target’s health are also applied to \[partner\].
...
- The [1.3.3](v1#v1.3.3) changes to Freeze were reverted.
- Petrify was removed.
...
- Status alignments were introduced. They are: Good, Bad, and Weird.
  ...
  - The following statuses were given the Bad alignment: Attack Down, Defense Down, Poison / Burn, Guard Break, Stun / Paralyze, Freeze, Death Sentence, Silence, Slow, Banished, Blind, Life Link, and Surrounded.
  - The following statuses were given the Weird alignment: Sleep, Confuse, Berserk, Bait, Undead / Zombie, Distance, and Dizzy.
