...
- Life Link was renamed to Lifelink, was realigned as a weird status, and was given a new effect to copy HP changes that the target receives to the affected. The original effect was given to a new status called Destiny Bond.
